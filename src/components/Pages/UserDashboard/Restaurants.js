...
import { Card, List, Icon, Tag, Divider } from 'antd';
...
const Restaurants = (props) => {
  return (
    <List
      ...
      renderItem={item => {
        return <Restaurant key={item._id} searchOption={props.searchOption} searchText={props.searchText} filterOptions={props.filterOptions} {...item} />
      }}
    />
  )
}
